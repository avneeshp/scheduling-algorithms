...
define void @test3(i16 signext %x1, i16 signext %y1, i16 signext %x2, i16 signext %y2,i16 signext %x3, i16 signext %y3, i16 signext %x4, i16 signext %y4, i16 signext %x5, i16 signext %y5, i16 signext %w, i16 signext %z) nounwind uwtable {
entry:
  %mul1 = mul i16 %x1, %y1
  %mul2 = mul i16 %x2, %y2
